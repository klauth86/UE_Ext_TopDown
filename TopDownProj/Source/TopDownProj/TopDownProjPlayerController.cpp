...
void ATopDownProjPlayerController::OnSetDestinationPressed()
{
...
void ATopDownProjPlayerController::OnSetDestinationReleased()
{
...
void ATopDownProjPlayerController::OnTouchPressed(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = true;
	OnSetDestinationPressed();
}

void ATopDownProjPlayerController::OnTouchReleased(const ETouchIndex::Type FingerIndex, const FVector Location)
{
	bIsTouch = false;
